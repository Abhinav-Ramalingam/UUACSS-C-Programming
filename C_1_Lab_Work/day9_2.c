...
/*
   ...
   */ 
    ...
    extra_values[0] = base_numbers[0];
    int extra_count = 1; // Count of extra values
...
*/
        ...
        // Store the first value of differences
        extra_values[extra_count++] = differences[0];
...
*/
    // Calculate the extrapolated value
    int extrapolated_value = 0; // Start with the first base number
    for (int i = extra_count - 2; i >= 0; i--) {
        extrapolated_value = extra_values[i] - extrapolated_value; // Subtract the values
    }
